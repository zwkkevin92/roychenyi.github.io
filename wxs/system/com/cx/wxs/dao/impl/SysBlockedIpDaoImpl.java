...
public class SysBlockedIpDaoImpl extends BaseDaoImpl<SysBlockedIp, Integer> implements SysBlockedIpDao{
    ...
    private BeanToDto<SysBlockedIp, SysBlockedIpDto> beanToDto=new BeanToDto<SysBlockedIp, SysBlockedIpDto>();

    public BeanToDto<SysBlockedIp, SysBlockedIpDto> getBeanToDto(){
        return beanToDto;
    }

    public void setBeanToDto(BeanToDto<SysBlockedIp, SysBlockedIpDto> beanToDto) {
