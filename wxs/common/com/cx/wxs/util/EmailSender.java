...
public class EmailSender {
	...
	public void setMessage(String title,String content){
		try {
			//设置发信人
			this.message.setFrom(new InternetAddress(this.user));
			//设置标题
	...
	public static  void main(String[] avg) throws IOException{
       String[] a={"852416288@qq.com"};
	   EmailSender email= new EmailSender("chenyi@9347.xyz","Ccy199290","smtp.mxhichina.com","25",a);
	   email.initProperties();
	   email.setReceiver();	   
	   email.setMessage("测试","测试！！");
	   email.sendEmail();
