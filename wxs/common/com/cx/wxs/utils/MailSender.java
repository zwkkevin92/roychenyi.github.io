...
public abstract class MailSender extends Authenticator {
    ...
    public static void main(String args[]) {
        String mailHost = "smtp.mxhichina.com";	//发送邮件服务器地址
        String mailUser = "wxs@9347.xyz";			//发送邮件服务器的用户帐号
        String mailPassword = "cjdx@2016";	//发送邮件服务器的用户密码
        String[] toAddress = {"tbyfchenyi@126.com","852416288@qq.com"};
        //使用超文本格式发送邮件
        ...
        //    sendmail.setAttachments("E:\\TOOLS\\pm_sn.txt");
            sendmail.setMailFrom("wxs@9347.xyz","文学社");
