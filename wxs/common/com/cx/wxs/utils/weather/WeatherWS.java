 ...
 * 2016-04-06T10:34:40.891+08:00
 * Generated source version: 2.7.10
 * 
 */
@WebServiceClient(name = "WeatherWS", 
                  wsdlLocation = "http://www.webxml.com.cn/WebServices/WeatherWS.asmx?wsdl",
...
public class WeatherWS extends Service {
    ...
    static {
        ...
        //  url=new URL(RequestUtils.getUserDir()+"/conf/weather.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(WeatherWS.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://www.webxml.com.cn/WebServices/WeatherWS.asmx?wsdl");
        }
        WSDL_LOCATION = url;
    }
